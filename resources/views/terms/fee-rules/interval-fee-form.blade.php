<div class="col-span-6 sm:col-span-3">
    ...
    <x-jet-input-error for="feeRules.{{$index}}.start_day" class="mt-3" />
</div>
...
<div class="col-span-6 sm:col-span-3">
    ...
    <x-jet-input-error for="feeRules.{{$index}}.interval" class="mt-3" />
</div>
...
<div class="col-span-6 sm:col-span-3">
    ...
    <x-forms.rate-input wire:model="feeRules.{{$index}}.max_rate" />
    <x-jet-input-error for="feeRules.{{$index}}.max_rate" class="mt-3" />
</div>
...
<div class="col-span-6 sm:col-span-3">
    ...
    <x-searchable-select :values="$types" wire:model="feeRules.{{$index}}.calculate_age_based_on" class="w-1/2 float-right"/>
</div>
