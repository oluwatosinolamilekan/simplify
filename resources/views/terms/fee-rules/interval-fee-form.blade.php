...
<div class="col-span-6 sm:col-span-3">
    ...
    <x-jet-input type="text" class="w-1/2 float-right" wire:model="feeRules.{{$index}}.configuration.interval" />
...
<div class="col-span-6 sm:col-span-3">
    ...
    <x-searchable :values="$types" wire:model="feeRules.{{$index}}.configuration.calculate_age_based_on" class="w-1/2 float-right"/>
</div>
