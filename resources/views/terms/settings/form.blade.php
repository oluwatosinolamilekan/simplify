        ...
        <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-md">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    @endphp
                    <x-select :values="$rules" wire:model="settings.collection_fee_rule"  class="w-1/2 float-right"/>
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    @endphp
                    <x-select :values="$rules" wire:model="settings.escrow_rebate_rule"  class="w-1/2 float-right"/>
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    @endphp
                    <x-select :values="$types" wire:model="settings.fee_base_date"  class="w-1/2 float-right"/>
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    @endphp
                    <x-select :values="$types" wire:model="settings.rate_base_type"  class="w-1/2 float-right"/>
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    @endphp
                    <x-select :values="$types" wire:model="settings.float_days_type"  class="w-1/2 float-right"/>
