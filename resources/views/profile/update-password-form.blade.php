    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            ...
            <div x-data="{ show: true }">
                <div class="relative">
                    <input id="current_password" :type="show ? 'password' : 'text'" class="form-control py-2 px-2 border-gray-300 block mt-1 w-full focus:border-theme-18 focus:ring-offset-theme-18 focus:ring-theme-18 focus:ring-opacity-50" wire:model.defer="state.current_password" autocomplete="current-password">
