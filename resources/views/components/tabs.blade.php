<div class="box">
    <div class="mt-4">
        <!-- BEGIN: Tabs -->
        <div class="nav nav-tabs flex-col sm:flex-row justify-center lg:justify-start border-b border-gray-200" role="tablist">
            <a id="dashboard-tab" data-toggle="tab" data-target="#dashboard" href="javascript:;" class="py-4 px-6 active" role="tab" aria-controls="dashboard" aria-selected="true">Dashboard</a>
            <a id="account-and-profile-tab" data-toggle="tab" data-target="#account-and-profile" href="javascript:;" class="py-4 px-6" role="tab" aria-selected="false">Account & Profile</a>
            <a id="activities-tab" data-toggle="tab" data-target="#activities" href="javascript:;" class="py-4 px-6" role="tab" aria-selected="false">Activities</a>
            <a id="tasks-tab" data-toggle="tab" data-target="#tasks" href="javascript:;" class="py-4 px-6" role="tab" aria-selected="false">Tasks</a>
        </div>
        <!-- END: Tabs -->
    </div>

    <div class="intro-y tab-content mt-5 px-4 pb-4">
