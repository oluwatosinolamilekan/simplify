<div class="flex space-x-1 justify-around">
    @if ($view)
    <a href="{{ route($view, [$id]) }}" target="_blank" class="p-1 text-teal-600 hover:bg-teal-600 hover:text-white rounded">
    ...
    @if ($update)
    <a href="{{ route($update, [$id]) }}" target="_blank" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
