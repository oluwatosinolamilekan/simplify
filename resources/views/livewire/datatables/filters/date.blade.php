<div x-data class="flex flex-col mr-2.5 ml-1 mb-3 date_input_min_with">
    <div class="w-full relative flex">
        <div class="relative">
            ...
            <x-input x-ref="range" id="datepicker" wire:selected="doDateFilterRange('{{ $index }}', $event.target.value)" class="h-8 mt-auto pr-7 mt-2.5 text-sm-13" placeholder="Select Date.." />
