            ...
            <form wire:submit.prevent="save">
                ...
                <div class="mt-10 sm:mt-0">
                    <div class="mt-6 md:grid md:grid-cols-3 md:gap-6">
                        ...
                        @include('clients.relation.form', ['client' => $client])
                    </div>
                </div>
                ...
                <div class="mt-10 sm:mt-0">
                    <div class="mt-6 md:grid md:grid-cols-3 md:gap-6">
                        ...
                        @include('clients.relation.factor-form', ['client' => $client])
                    </div>
                </div>
                ...
                <div class="mt-10 sm:mt-0">
                    <div class="mt-6 md:grid md:grid-cols-3 md:gap-6">
                        ...
                        @include('clients.credit.form', ['credit' => $credit, 'partial' => true, 'nested' => true])
                    </div>
                </div>
