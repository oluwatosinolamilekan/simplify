    ...
    <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-md">
        <div class="grid grid-cols-6 gap-6">
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <x-jet-input id="street" type="text" class="mt-1 block w-full" wire:model.defer="address.street" autocomplete="street-address"/>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <select id="country" wire:model.defer="address.country" class="mt-1 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <x-jet-input id="zip_code" type="text" class="mt-1 block w-full" wire:model.defer="address.zip_code" autocomplete="postal-code"/>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <x-jet-input id="mail_code" type="text" class="mt-1 block w-full" wire:model.defer="address.mail_code"/>
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <x-jet-input id="timezone" type="text" class="mt-1 block w-full" wire:model.defer="address.timezone"/>
